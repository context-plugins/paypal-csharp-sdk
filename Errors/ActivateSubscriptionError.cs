...
public sealed class ActivateSubscriptionError : ApiError
{
    ...
    private ActivateSubscriptionError(Optional<SubscriptionError> subscriptionErrorValue,
        Optional<RawError> fallback) : base(fallback)
    {
        _subscriptionErrorValue = subscriptionErrorValue;
    }

    private static ActivateSubscriptionError AsSubscriptionError(SubscriptionError value) =>
