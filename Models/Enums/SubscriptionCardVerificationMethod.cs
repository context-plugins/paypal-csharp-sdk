...
/// </summary>
[JsonConverter(typeof(StringEnumConverter<SubscriptionCardVerificationMethod>))]
public sealed record SubscriptionCardVerificationMethod : StringEnum<SubscriptionCardVerificationMethod>
{
    private SubscriptionCardVerificationMethod(string value) : base(value)
    {
    }
    ...
    /// </summary>
    public static readonly SubscriptionCardVerificationMethod ScaAlways = new("SCA_ALWAYS");
    ...
    /// </summary>
    public static readonly SubscriptionCardVerificationMethod ScaWhenRequired = new("SCA_WHEN_REQUIRED");
    ...
    /// </summary>
    public static readonly SubscriptionCardVerificationMethod _3DSecure = new("3D_SECURE");
    ...
    /// </summary>
    public static readonly SubscriptionCardVerificationMethod AvsCvv = new("AVS_CVV");

    public static SubscriptionCardVerificationMethod FromValue(string value) => FromValueCore(value);
}
